...
<main id="main-content" class="max-w-5xl mx-auto px-4 py-12 md:py-16">
    ...
    <section class="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg p-6 md:p-8 mb-8">
        <h2 class="text-2xl font-bold text-slate-900 dark:text-white mb-4">قبل البدء</h2>
        <ul class="list-disc ps-6 space-y-2 text-slate-700 dark:text-slate-300 leading-8">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <article class="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg p-6">
            <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-3">uBlock Origin</h3>
            <ol class="list-decimal ps-6 space-y-2 text-slate-700 dark:text-slate-300 leading-8">
    ...
    <section class="bg-primary/10 border border-primary/30 rounded-lg p-6 md:p-8 text-center">
