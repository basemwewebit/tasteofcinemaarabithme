...
<main class="max-w-5xl mx-auto px-4 py-12 md:py-16">
    <header class="text-center mb-10">
        ...
        <h1 class="text-3xl md:text-5xl font-bold text-slate-900 dark:text-white mb-4 leading-[1.3]">كيف تدعم الموقع مع مانع الإعلانات؟</h1>
    ...
    <section class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 md:p-8 shadow-sm mb-8">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <article class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-sm">
