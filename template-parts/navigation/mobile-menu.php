...
<div id="mobile-menu" class="fixed top-0 start-0 h-full w-[85vw] max-w-80 bg-slate-50 dark:bg-slate-900 shadow-2xl z-50 border-e border-slate-200 dark:border-slate-800 flex flex-col" role="dialog" aria-modal="true" aria-hidden="true" inert aria-label="<?php esc_attr_e('القائمة', 'mazaq'); ?>">
    <div class="p-6 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
        ...
        <button id="close-menu" aria-label="<?php esc_attr_e('إغلاق القائمة', 'mazaq'); ?>" class="p-2 text-slate-600 dark:text-slate-300 hover:text-red-600 dark:hover:text-red-300 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2 rounded-sm">
