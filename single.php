                ...
                <div class="mb-8">
                    ...
                    <div class="flex flex-wrap items-center gap-6 text-sm text-slate-500 dark:text-slate-400 font-medium font-mono pb-6 border-b border-slate-200 dark:border-slate-800">
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                <span class="block text-slate-900 dark:text-white font-bold font-sans text-base">بواسطة: <?php the_author(); ?></span>
                                <span><?php echo esc_html__('ناقد سينمائي', 'mazaq'); ?></span>
                            </div>
                        </div>
                        <div class="flex items-center gap-2">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span><?php echo esc_html(mazaq_reading_time(get_the_ID())); ?></span>
                        </div>
                    </div>
                </div>
