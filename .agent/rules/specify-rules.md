...
## Recent Changes
- 001-fix-single-post: Added PHP 8.0+, HTML5, CSS3, JS (Vanilla) + WordPress 6.0+, active theme (`tasteofcinemaarabithme`)

- 001-slice-to-wp-theme: Added PHP 8.1+, JavaScript (ES6+/jQuery), HTML5, CSS3 + WordPress 6.4+, Tailwind CSS 3.x (compiled), jQuery (WP bundled), Secure Custom Fields (SCF) plugin
